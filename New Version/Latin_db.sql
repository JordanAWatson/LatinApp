...
CREATE TABLE dictionary (
	verb VARCHAR(28) CHARACTER SET UTF8MB4,
    conjugation VARCHAR(6),			/* 1st, 2nd, 3rd, 4th, 3rd-io */
    PRIMARY KEY (verb)
);

CREATE TABLE verbForm (
	form VARCHAR(28) CHARACTER SET UTF8MB4,			/* The conjugated verb form */
    stem VARCHAR(28) CHARACTER SET UTF8MB4,			/* Its first principle part */
    PRIMARY KEY (form),
...
CREATE TABLE formInfo (
	form VARCHAR(28) CHARACTER SET UTF8MB4,
